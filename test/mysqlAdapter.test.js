...
describe('database diagnostics', () => {
    ...
    describe('get ONE customer with specified fields', () => {
        ...
        it('should be able to extract requested fields on a specific customer', (done) => {
            ...
            dbAdappter.getONEcustomerObject('3',
                ['customers.companyName,customers.companyWorth', 'customers.noEmployees,tenders.tenderValue']).then((result) => {
                    ...
                    expect(result[0].tenderValue).to.be.equal(200);
                    ...
                    expect(result[1].tenderValue).to.be.equal(500);
        ...
        it('it should return no value if customer ID is not in database', (done) => {
            ...
            dbAdappter.getONEcustomerObject('4', ['customers.companyName,customers.companyWorth', 'customers.noEmployees']).then((result) => {
        ...
        it('it should display error if a requested field does not exist, without crashing', (done) => {
            ...
            dbAdappter.getONEcustomerObject('3', ['customers.age,customers.companyWorth', 'customers.noEmployees']).then((result) => {
    ...
    describe('get ALL customers with specified fields', () => {
        ...
        it('should be able to extract requested fields from a table', (done) => {
            ...
            dbAdappter.getALLcustomerObjects(['customers.companyName,customers.companyWorth,tenders.tenderValue', 'customers.noEmployees']).then((result) => {


                expect(result[0].companyName).to.be.equal('companyA');
                expect(result[0].companyWorth).to.be.equal(2000000);
                expect(result[0].noEmployees).to.be.equal(15);
                expect(result[0].tenderValue).to.be.equal(50);
                ...
                expect(result[2].companyName).to.be.equal('companyB');
                expect(result[2].companyWorth).to.be.equal(23000000);
                expect(result[2].noEmployees).to.be.equal(45);
                expect(result[2].tenderValue).to.be.equal(150);

                expect(result[3].companyName).to.be.equal('companyC');
                expect(result[3].companyWorth).to.be.equal(1000000000);
                expect(result[3].noEmployees).to.be.equal(400);
                expect(result[3].tenderValue).to.be.equal(200);

                expect(result[4].companyName).to.be.equal('companyC');
                expect(result[4].companyWorth).to.be.equal(1000000000);
                expect(result[4].noEmployees).to.be.equal(400);
                expect(result[4].tenderValue).to.be.equal(500);
                done();
            })
        })
        ...
        it('it should display error if a requested field does not exist, without crashing', (done) => {
            ...
            dbAdappter.getALLcustomerObjects(['customers.age,customers.companyWorth', 'customers.noEmployees']).then((result) => {
